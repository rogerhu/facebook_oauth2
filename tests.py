...
class FBTestSuite(unittest.TestCase):
    ...
    def test_get_signed_fb_request_non_expired_key(self, mock):
        ...
        mock.return_value = {"access_token": "15996268430383|c58b2c04d1fef1554b6408dd-1474622354|as2tU6y_eTkbeMXJuCWVZ4P1ewM."}
    ...
    def test_get_signed_fb_request_expired_key(self, mock):
        ...
        mock.return_value = {"access_token": "115996268430383|2.M6Q5rZjJIkfAO_0UNuIDSQ__.3600.1273741200-1474622354|z79TisIrBPIVKlm7i6qFGATy5Fg."}
